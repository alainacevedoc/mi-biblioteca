...
<div className="flex gap-2 overflow-x-auto mb-6">
  ...
  <div className="bg-white rounded-2xl p-4 shadow-sm mb-6 space-y-3">
    <input className="w-full border border-[#ddd6cc] bg-[#111827] text-[#382110] rounded-xl p-3" placeholder="Título del libro" value={title} onChange={(e) => setTitle(e.target.value)} />
    <button
...
>
  Buscar portada y autor
    ...
    <input className="bg-[#111827] text-[#382110] border border-[#ddd6cc] px-4 py-3 rounded-xl text-sm w-full" placeholder="Autor" value={author} onChange={(e) => setAuthor(e.target.value)} />
    ...
    <input className="w-full border border-[#ddd6cc] bg-[#111827] text-[#382110] rounded-xl p-3" placeholder="URL de la portada" value={cover} onChange={(e) => setCover(e.target.value)} />
    <input
  type="date"
...
/>
    <textarea className="w-full border border-[#ddd6cc] bg-[#111827] text-[#382110] rounded-xl p-3 p-3" placeholder="Reseña personal" value={review} onChange={(e) => setReview(e.target.value)} />
